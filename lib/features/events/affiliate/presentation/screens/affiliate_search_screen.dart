...
//  The _AffiliateSearchScreenState class is where the main functionality of the feature is implemented.
...
class AffiliateSearchScreen extends StatefulWidget {
  static final id = 'AffiliateSearchScreen';
  ...
  @override
  _AffiliateSearchScreenState createState() => _AffiliateSearchScreenState();
}
...
// This can help prevent memory leaks and improve the overall performance of the app.
  ...
  _sendInvite() async {
    ...
    Future<void> sendInvites() => DatabaseService.createAffiliate(
          event: widget.event,
          users: selectedUsersList,
          inviteMessage: widget.inviteMessage,
              ...
              child: Scaffold(
                ...
                body: Padding(
                  ...
                  child: ListView(children: [
                    ...
                    Text(
                      'The invitation sent must be accepted by the invitees bfore they can become and affiliate. Invities are not obliged to accept your invitation.',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize:
                            ResponsiveHelper.responsiveFontSize(context, 14.0),
...
// The build method of the _AffiliateSearchScreenState class returns a Scaffold widget that contains the search
            ...
            Expanded(
              child: Container(
                child: _users.value.isEmpty
                    ? Center(
                        child: _noContentNow(
                        'Seach potential affiliate invitee',
                        'Enter the name of the user you would like to invite to to be your affiliate marketer',
                        Icons.person_add_alt,
                      ))
                    : _buildResults(),
              ),
