...
class FriendshipMatchingWidget extends StatefulWidget {
  final UserFriendshipModel friendshipMatching;
  final String currentUserId;

  // final String tab;
  // final String tabValue;

  const FriendshipMatchingWidget({
    super.key,
    required this.friendshipMatching,
  ...
  @override
  State<FriendshipMatchingWidget> createState() =>
      _FriendshipMatchingWidgetState();
}

class _FriendshipMatchingWidgetState extends State<FriendshipMatchingWidget> {
          ...
          return Container(
            ...
            child: Padding(
                ...
                child: ListView(children: [
                  ...
                  MarkdownBody(
                    data: widget.friendshipMatching.matchReason!,
                    styleSheet: MarkdownStyleSheet(
                      h1: Theme.of(context).textTheme.titleLarge,
                      h2: Theme.of(context).textTheme.titleMedium,
                      p: Theme.of(context).textTheme.bodyMedium,
  ...
  _insight() {
    ...
    // switch (widget.tab) {
    //   case 'skills':
    //     insightType = widget.friendshipMatching.skills;
    //     break;
    //   case 'shortTermGoals':
    //     insightType = widget.friendshipMatching.shortTermGoals;
    //     break;
    //   case 'longTermGoals':
    //     insightType = widget.friendshipMatching.longTermGoals;
    //     break;
    //   case 'creativeStyle':
    //     insightType = widget.friendshipMatching.creativeStyle;
    //     break;
    //   case 'inspiration':
    //     insightType = widget.friendshipMatching.inspiration;
    //     break;
    // }
        ...
        return Container(
          ...
          child: Padding(
            ...
            child: BottomModalSheetMessage(
              ...
              userId: widget.friendshipMatching.userId!,
              showAppbar: false,
            ),
          ),
        );
              ...
              : () async {
                  ...
                  try {
                    UserProfessionalModel? _userProfessional =
                      ...
                      widget.friendshipMatching.userId!,
                    );
  ...
  _tabValues() {
    ...
    // switch (widget.tab) {
    //   case 'skills':
    //     tabValue = widget.friendshipMatching.skills;
    //     tab = 'skills';
    //     break;
    //   case 'shortTermGoals':
    //     tabValue = widget.friendshipMatching.shortTermGoals;
    //     tab = 'Short Term Goals';
    //     break;
    //   case 'longTermGoals':
    //     tabValue = widget.friendshipMatching.longTermGoals;
    //     tab = 'Long Term Goals';
    //     break;
    //   case 'creativeStyle':
    //     tabValue = widget.friendshipMatching.creativeStyle;
    //     tab = 'Creative Style';
    //     break;
    //   case 'inspirations':
    //     tabValue = widget.friendshipMatching.inspiration;
    //     tab = 'Inspiration';
    //     break;
    // }
    return Column(children: [
      _matchingWidget('Goal', widget.friendshipMatching.goal!, false),
    ]);
  }
  ...
  _values() {
    return Column(children: [
      _matchingWidget('Goal', widget.friendshipMatching.goal!, true),
      _matchingWidget('Reason', widget.friendshipMatching.matchReason!, true),
      // _matchingWidget('Long Term Goals', widget.friendshipMatching.skills, true),
      // _matchingWidget('Creative Style', widget.friendshipMatching.skills, true),
      // _matchingWidget('Inspirations', widget.friendshipMatching.skills, true),
    ]);
  }
          ...
          GestureDetector(
            onTap: () {
              _navigateToPage(
                ProfileScreen(
                  currentUserId: widget.currentUserId,
                  userId: widget.friendshipMatching.userId, user: null,
                  // userIndex: 0,
            ...
            child: Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  widget.friendshipMatching.profileImageUrl!.isEmpty
                      ? const Icon(
                      ...
                      : CircleAvatar(
                          ...
                          backgroundImage: CachedNetworkImageProvider(
                              widget.friendshipMatching.profileImageUrl!),
                        ),
                  SizedBox(
                  ...
                  Column(
                    ...
                    children: [
                      NameText(
                        ...
                        name: widget.friendshipMatching.userName!
                            .toUpperCase()
                            .trim()
                            .replaceAll('\n', ' '),
                        verified: widget.friendshipMatching.verified!,
                      ),
                      Text(widget.friendshipMatching.profileHandle!,
                          style: TextStyle(
