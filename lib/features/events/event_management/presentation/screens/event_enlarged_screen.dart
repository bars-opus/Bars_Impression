...
//   }
  ...
  //   });
  // }
// // The Cloud Audio, Clover street, Tema, Ghana
//   void debugAddress(String address) {
//     print('Original Address: "$address"');
//     print('Trimmed Address: "${address.trim()}"');
//     for (int i = 0; i < address.length; i++) {
//       print(
//           'Character at $i: ${address[i]} (code unit: ${address.codeUnitAt(i)})');
//     }
//   }
  ...
  Future<void> _setInitialPosition() async {
    ...
    //   print(widget.event.address);
    //   var latLng =
    //       await addressService.getLatLngFromAddress(widget.event.address);
    ...
    try {
      ...
      // String normalizedAddress = widget.event.address.trim();
      // print(normalizedAddress);
      // Debug the addressp
      // debugAddress(normalizedAddress);

      // List<Location> results = await locationFromAddress(normalizedAddress);
      // print('hjkhjk' + results.length.toString());
  ...
  //  5.653311499999999,  -0.0203699
  // latLng

//  Community 11 Complex Jhs, Tema, Ghana
//  5.664843900000001, -0.0256493

//  Our Lady of Mercy Senior High School (OLAMS), Republic Rd, Community One, Tema, Ghana
//  5.6502316, -0.0085979

//  MARLIN RESORT, Gomoa Fetteh, Ghana
// 5.4422265, -0.4459961999999999

// The Greens Lounge, Sixth Avenue, Tema, Ghana
//  5.6740093, -0.0128804
    ...
    return ListView(
      ...
      children: [
                      ...
                      builder: (BuildContext context) {
                        return Container(
                          height: ResponsiveHelper.responsiveHeight(
                              context, selectedEvents.isEmpty ? 700 : 800),
                          width:
          ...
          child: RichText(
            ...
            text: TextSpan(
              children: [
                ...
                TextSpan(
                  text:
                      '\nTap on the red location icon for venue direction.\nDouble tap on map to zoom in. ',
                  style: greyTextStyle,
                ),
              ],
            ),
        ...
        Container(
          ...
          height: ResponsiveHelper.responsiveHeight(
              context,
              widget.event.previousEvent.isNotEmpty || _showAffiliate
                  ? 400
                  : widget.event.previousEvent.isNotEmpty && _showAffiliate
                      ? 450
                      : 330.0),
