...
class _ClientProfileState extends State<ClientProfile>
  ...
  _loadMoreInvites() async {
    try {
      Query activitiesQuery = widget.currentUserId == widget.client.userId
          ? userInvitesRef
              .doc(widget.client.userId)
  ...
  void _showBottomSheetMore(String from) {
    ...
    final bool _isAuthor = widget.currentUserId == widget.client.userId;
  ...
  //                       TextSpan(
  //                         text:
  //                             "\n\n${widget.client.overview.trim().replaceAll('\n', ' ')}",
  ...
  //             ),
  //             OpeninHoursWidget(
  //               openingHours: widget.client.openingHours,
  //             )
  //           ],
  //         ),
  //       );
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: EditProfileScreen(
              ...
              shop: null,
              worker: null,
              accountType: widget.client.accountType!,
            ),
          ),
        );
      },
  ...
  _followContainer() {
    ...
    bool _isAuthor = widget.client.userId == widget.currentUserId;
    return Container(
          ...
          child: Column(
            children: [
              ...
              ProfileImageHeaderWidget(
                ...
                verified: widget.client.verified!,
                name: widget.client.userName!,
                shopOrAccountType: widget.client.accountType!,
                user: null,
              ...
              //     },
              //     child: ShopOpenStatus(shop: widget.client)),

              // divider,
              // GestureDetector(
              //   onTap: () {
              //     _launchMap(widget.client.address);
              //   },
              ...
              actions: [
                ...
                ListTile(
                  trailing: _isAuthor
                      ...
                      : null,
                  leading: widget.client.profileImageUrl!.isEmpty
                      ? Icon(
                  ...
                  title: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                            text: widget.client.userName!.toUpperCase(),
                            style: Theme.of(context).textTheme.bodyMedium),
                        TextSpan(
                          text: "\n${widget.client.shopType}",
                          style: TextStyle(
                              color: Colors.blue,
                  ...
                  () {
                    _isAuthor
                        ...
                        : _navigateToPage(
                            context,
                            SendToChats(
                              sendContentId: widget.client.userId!,
                              currentUserId:
                                  Provider.of<UserData>(context, listen: false)
                                      .currentUserId!,
                              sendContentType: 'User',
                              sendImageUrl: widget.client.profileImageUrl!,
                              sendTitle: widget.client.userName!,
                            ));
                  },
                ...
                _sortByWidget(
                  _isAuthor
                      ? () async {
                          Share.share(widget.client.dynamicLink!);
                        }
                      : () {
                          // _blockOrUnBlock(widget.client);
                        },
                ...
                //         context,
                //         UserBarcode(
                //           widget.clientDynamicLink: widget.client.dynamicLink!,
                //           bio: widget.client.bio!,
                //           widget.clientName: widget.client.widget.clientName!,
                //           widget.clientId: widget.client.widget.clientId!,
                //           profileImageUrl: widget.client.profileImageUrl!,
                //         ));
                //   },
                //   Icons.qr_code,
                //   'Bar code',
                ...
                //         context,
                //         UserBarcode(
                //           widget.clientDynamicLink: user.dynamicLink!,
                //           bio: user.bio!,
                    ...
                    _sortByWidget(
                      () {
                        _navigateToPage(
                            context,
                            UserBarcode(
                              userDynamicLink: widget.client.dynamicLink!,
                              bio: '',
                      ...
                      _isAuthor
                          ...
                          : () {
                              _navigateToPage(
                                  context,
                                  ReportContentPage(
                                    contentId: widget.client.userId!,
                                    contentType: widget.client.userName!,
                                    parentContentId: widget.client.userId,
                                    repotedAuthorId: widget.currentUserId,
                                  ));
                            },
                  ...
                  child: GestureDetector(
                    onTap: () {
                      _navigateToPage(
                          ...
                          CompainAnIssue(
                            parentContentId: widget.client.userId!,
                            authorId: widget.client.userId!,
                            complainContentId: widget.client.userId!,
                            complainType: 'Account',
                            parentContentAuthorId: widget.client.userId!,
                          ));
                    },
                    child: Text(
                      'Complain an issue.',
  ...
  _mainShopInfo(
    ...
    bool _isCurrentUser = widget.currentUserId == widget.client.userId;

    return Material(
      color:

          //  widget.client.userId == widget.currentUserId
      ...
      child: NestedScrollView(
            ...
            SliverAppBar(
              ...
              actions: [
                MoreIconWidget(
                    isAuthor: _isAuthor,
                    imageUrl: widget.client.profileImageUrl!,
                    dynamicLink: widget.client.dynamicLink!,
                    userId: widget.client.userId!,
                    userName: widget.client.userName!,
                    currentUserId: widget.currentUserId,
                    accountType: widget.client.accountType!,
        ...
        body: Material(
          ...
          child: TabBarView(
            controller: _tabController,
            children: <Widget>[
              _mainShopInfo(_isAuthor),
              _shopPosts(_isAuthor),
            ],
          ),
        ),
      ),
