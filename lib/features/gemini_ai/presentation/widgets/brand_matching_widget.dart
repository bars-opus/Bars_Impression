...
//     final prompt =
//         'Compare the following ${widget.tab} and give a give a detauled analysis of what the have in common and why two people with this ${widget.tab} would be able to collaborate or work :\n\ntype 1: ${widget.tabValue}\n\ntype 2: $matchingValue}\n\nScore:';
...
//   _mathingWidget(String title, String body, bool isDetails) {
//     return RichText(
//       textScaleFactor: MediaQuery.of(context).textScaleFactor.clamp(0.5, 1.5),
//       text: TextSpan(
//         children: [
...
//       ),
//       _buttons(
//           _provider.isLoading ? 'looding..' : 'Message',
//           _provider.isLoading
//               ? () {}
//               : () async {
//                   _provider.setIsLoading(true);
...
//                   // });
//                 },
//           _provider.isLoading ? 'looding..' : 'Contact',
//           _provider.isLoading
//               ? () {}
//               : () async {
//                   _provider.setIsLoading(true);
...
//     }
//     return Column(children: [
//       _mathingWidget(tab, tabValue, false),
//     ]);
//   }

//   _values() {
//     return Column(children: [
//       _mathingWidget('Skill', widget.brandMatching.skills, true),
//       _mathingWidget('Short Term Goals', widget.brandMatching.skills, true
//           // widget.brandMatching.shortTermGoals,
//           ),
//       _mathingWidget('Long Term Goals', widget.brandMatching.skills, true
