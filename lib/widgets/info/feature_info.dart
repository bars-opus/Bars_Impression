                          ...
                          : widget.feature.startsWith('Event')
                              ? Column(
                                  ...
                                  children: [
                                      ...
                                      ShakeTransition(
                                        child: Text(
                                          'Create a music event where people can attend, have fun, create memories, and have unforgettable experiences. You can create a virtual event that can be hosted on a live stream of other platforms, or you can create an event of a physical venue that people can attend. You can choose between a category of music events.',
                                          style: TextStyle(
                                            color: ConfigBloc().darkModeOn
                                                ? Colors.grey
                                                : Colors.black,
                                      ...
                                      ShakeTransition(
                                        child: Padding(
                                          ...
                                          child: FeatureInfoWidget(
                                            title: 'Others',
                                            subTitle:
                                                'Promote other upcoming music events.',
                                            number: '5',
                                          ),
                                        ),
                                      ),
