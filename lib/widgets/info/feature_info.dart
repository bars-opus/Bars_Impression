                    ...
                    child: widget.feature.startsWith('Punch')
                        ? Column(
                            ...
                            children: [
                                ...
                                ShakeTransition(
                                  child: Text(
                                    'We know how it feels when you are listening to a song, and the lines in the song just hit differently, the rhymes aligned on every line perfectly, the punchline (quotes music lyrics) painting a picture in front of you vividly. And you wish someone could relate with you. Well, someone could. You know how when you take a picture you just wish there are words to express your mood in that picture? We have created a creative way for you to express your mood by using your favorite quotes from the lyrics(punchline). We call it punching your mood. Punch your mood by posting a picture and associating the mood of the picture with a punchline. You can honor your favorite artist by punching your mood using their punchline. But first, the mood of the picture has to be related to the punchline you are using. For instance, when you are celebrating a special occasion, your punchline should not be about struggle or hustle, but rather happiness or success. \nBelow is the different aspects of punching your mood.',
                                    style: TextStyle(
                                      color: ConfigBloc().darkModeOn
                                          ? Colors.grey
                                          : Colors.black,
                                            ...
                                            child: RichText(
                                              ...
                                              text: TextSpan(
                                                children: [
                                                  ...
                                                  TextSpan(
                                                    text:
                                                        'The public status of an invitation card shows that an event is a public event and the attendee doesn\'t need a special invitation to attend. He can tap on attend on the event flyer to generate a card with an check-in number. ',
                                                    style: TextStyle(
                                                      fontSize: 12,
                                                      color: ConfigBloc()
                                                              .darkModeOn
                                                  ...
                                                  TextSpan(
                                                    text:
                                                        'This status appears on an invitation card if an event organizer sends an invitation to a person who didn\'t request to attend an event. In this case, the event organizer is specifically and specifically inviting that person. This invitation card needs to be accepted by the person the event organizer is inviting. This invitation card has an invite number. When a person accepts the invitation, an check-in number would be generated for the person and the status of the invitation would change to attending. The event organizer would be notified when an invited person accepts an invitation. An invited person can choose to accept or reject an invitation. An invited person is not obliged to accept an invitation. ',
                                                    style: TextStyle(
                                                      fontSize: 12,
                                                      color: ConfigBloc()
                                                              .darkModeOn
                                                  ...
                                                  TextSpan(
                                                    text:
                                                        'This status indicates that an attendee would be attending a specific event. This attending status has an check-in number. when an invitation card has this status, the event of that invitation card would be added to the list of events an attendee would be attending on the event feed of the attendee. A countdown would be added to the event to remind the attendee.',
                                                    style: TextStyle(
                                                      fontSize: 12,
                                                      color: ConfigBloc()
                                                              .darkModeOn
                                          ...
                                          child: RichText(
                                            ...
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      '\nAn attendee is a person who would be attending a specific event. A person has to get an check-in number to become an attendee. Without an check-in number, a person is not an attendee.',
                                                  style: TextStyle(
                                                    fontSize: 12,
                                                    color:
                                                        ConfigBloc().darkModeOn
                                          ...
                                          child: RichText(
                                            ...
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      '\nAn check-in number indicates that a person is an attendee an event. An check-in number is a unique number generated for each attendee when a person accepts an event invitation or if an event organizer accepts the invitation request of a person.',
                                                  style: TextStyle(
                                                    fontSize: 12,
                                                    color:
                                                        ConfigBloc().darkModeOn
