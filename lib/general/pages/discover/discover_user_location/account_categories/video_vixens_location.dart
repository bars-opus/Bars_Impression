...
class VideoVixensLocation extends StatefulWidget {
  static final id = 'VideoVixensLocation';
  ...
  @override
  _VideoVixensLocationState createState() => _VideoVixensLocationState();
}

class _VideoVixensLocationState extends State<VideoVixensLocation>
  ...
  _setupUsers() async {
    QuerySnapshot userFeedSnapShot = await usersRef
        .where('profileHandle', isEqualTo: 'Video_Vixen')
