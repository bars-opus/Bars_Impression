...
class DancersLocation extends StatefulWidget {
  static final id = 'DancersLocation';
  ...
  @override
  _DancersLocationState createState() => _DancersLocationState();
}

class _DancersLocationState extends State<DancersLocation>
  ...
  _setupUsers() async {
    QuerySnapshot userFeedSnapShot = await usersRef
        .where('profileHandle', isEqualTo: 'Dancer')
