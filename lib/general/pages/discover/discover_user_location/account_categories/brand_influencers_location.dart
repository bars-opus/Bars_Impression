...
class BrandInfluencersLocation extends StatefulWidget {
  static final id = 'BrandInfluencersLocation';
  ...
  @override
  _BrandInfluencersLocationState createState() =>
      _BrandInfluencersLocationState();
}

class _BrandInfluencersLocationState extends State<BrandInfluencersLocation>
  ...
  _setupUsers() async {
    QuerySnapshot userFeedSnapShot = await usersRef
        .where('profileHandle', isEqualTo: 'Brand_Influencer')
