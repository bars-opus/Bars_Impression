...
class DesignersLocation extends StatefulWidget {
  static final id = 'DesignersLocation';
  ...
  @override
  _DesignersLocationState createState() => _DesignersLocationState();
}

class _DesignersLocationState extends State<DesignersLocation>
 ...
 int limit = 5;
  ...
  _setupUsers() async {
    QuerySnapshot userFeedSnapShot = await usersRef
        .where('profileHandle', isEqualTo: 'Cover_Art_Designer')
