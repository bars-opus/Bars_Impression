...
class MakeUpArtistsLocation extends StatefulWidget {
  static final id = 'MakeUpArtistsLocation';
  ...
  @override
  _MakeUpArtistsLocationState createState() => _MakeUpArtistsLocationState();
}

class _MakeUpArtistsLocationState extends State<MakeUpArtistsLocation>
  ...
  _setupUsers() async {
    QuerySnapshot userFeedSnapShot = await usersRef
        .where('profileHandle', isEqualTo: 'Makeup_Artist')
