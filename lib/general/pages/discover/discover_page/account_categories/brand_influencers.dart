...
class BrandInfluencers extends StatefulWidget {
  static final id = 'BrandInfluencers';
  ...
  @override
  _BrandInfluencersState createState() => _BrandInfluencersState();
}

class _BrandInfluencersState extends State<BrandInfluencers>
...
_setupUsers() async {
    QuerySnapshot userFeedSnapShot = await accountTypesRef
        .doc('Brand_Influencer')
        .collection('Brand_Influencer')
