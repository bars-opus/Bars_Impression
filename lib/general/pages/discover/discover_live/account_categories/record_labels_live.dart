...
class RecordLabelsLive extends StatefulWidget {
  static final id = 'RecordLabelsLive';
  ...
  @override
  _RecordLabelsLiveState createState() => _RecordLabelsLiveState();
}

class _RecordLabelsLiveState extends State<RecordLabelsLive>
  ...
  _setupUsers() async {
    QuerySnapshot userFeedSnapShot = await usersRef
        ...
        .where('profileHandle!', isEqualTo: 'Producer')
        .limit(limit)
        .get();
