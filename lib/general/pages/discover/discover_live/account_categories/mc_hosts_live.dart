...
class MCHostsLive extends StatefulWidget {
  static final id = 'MCHostsLive';
  ...
  @override
  _MCHostsLiveState createState() => _MCHostsLiveState();
}

class _MCHostsLiveState extends State<MCHostsLive>
