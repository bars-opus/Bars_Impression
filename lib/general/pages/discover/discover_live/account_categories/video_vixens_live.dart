...
class VideoVixensLive extends StatefulWidget {
  static final id = 'VideoVixensLive';
  ...
  @override
  _VideoVixensLiveState createState() => _VideoVixensLiveState();
}

class _VideoVixensLiveState extends State<VideoVixensLive>
