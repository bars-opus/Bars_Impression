...
class MakeUpArtistsLive extends StatefulWidget {
  static final id = 'MakeUpArtistsLive';
  ...
  @override
  _MakeUpArtistsLiveState createState() => _MakeUpArtistsLiveState();
}

class _MakeUpArtistsLiveState extends State<MakeUpArtistsLive>
