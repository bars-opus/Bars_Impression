...
class DancersLive extends StatefulWidget {
  static final id = 'DancersLive';
  ...
  @override
  _DancersLiveState createState() => _DancersLiveState();
}

class _DancersLiveState extends State<DancersLive>
