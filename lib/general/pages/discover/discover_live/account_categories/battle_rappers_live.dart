...
class BattleRappersLive extends StatefulWidget {
  static final id = 'BattleRappersLive';
  ...
  @override
  _BattleRappersLiveState createState() => _BattleRappersLiveState();
}

class _BattleRappersLiveState extends State<BattleRappersLive>
