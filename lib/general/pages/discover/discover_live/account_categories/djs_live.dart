...
class DjsLive extends StatefulWidget {
  static final id = 'DjsLive';
  ...
  @override
  _DjsLiveState createState() => _DjsLiveState();
}

class _DjsLiveState extends State<DjsLive> with AutomaticKeepAliveClientMixin {
