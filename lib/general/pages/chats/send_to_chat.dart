    ...
    showCupertinoModalPopup(
        ...
        builder: (BuildContext context) {
          return CupertinoActionSheet(
            title: Text(
              'Are you sure you want to send this content to ${widget.author.userName}?',
              style: TextStyle(
                fontSize: 16,
                color: ConfigBloc().darkModeOn ? Colors.white : Colors.black,
              ),
...
// class _searchedDisplay extends StatefulWidget {
//   final AccountHolder author;
//   final Chat chats;
//   String lastMessage;
//   String seen;
...
//   @override
//   State<_searchedDisplay> createState() => _searchedDisplayState();
// }

// class _searchedDisplayState extends State<_searchedDisplay> {
//   int _chatMessageCount = 0;
...
//         message: 'MoodPunched',
//         sendPostType: widget.sendContentType,
//         sendContentId: Provider.of<UserData>(context, listen: false).post12,
//       );
...
//         message: 'MoodPunched',
//         sendPostType: widget.sendContentType,
//         sendContentId: Provider.of<UserData>(context, listen: false).post12, sendContentTitle: ,
//       );
...
//   Widget build(BuildContext context) {
//     return SearchUserTile(
//         userName: widget.author.userName!.toUpperCase(),
//         profileHandle: widget.author.profileHandle!,
//         verified: widget.author.verified,
//         company: widget.author.company!,
//         profileImageUrl: widget.author.profileImageUrl!,
//         bio: widget.author.bio!,
//         score: widget.author.score!,
//         onPressed: () {
//           _showSelectImageDialog();
//         });
    // Padding(
